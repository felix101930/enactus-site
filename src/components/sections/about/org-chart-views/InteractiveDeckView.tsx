...
const DeckItem = ({ member }: { member: any }) => (
  ...
  >
    {member.image ? (
      <img src={member.image} alt={member.name} className="w-10 h-10 rounded-full object-cover shrink-0 border border-gray-100" />
    ) : (
                ...
                >
                  ...
                  <div className="mb-4 p-4 bg-gray-50 rounded-xl flex items-center gap-4">
                    {data.operations.vp.image ? (
                      <img src={data.operations.vp.image} alt={data.operations.vp.name} className="w-12 h-12 rounded-full object-cover shrink-0 border-2 border-gray-200" />
                    ) : (
                ...
                >
                  ...
                  <div className="mb-4 p-4 bg-white/40 rounded-xl flex items-center gap-4">
                    {data.projects.vp.image ? (
                      <img src={data.projects.vp.image} alt={data.projects.vp.name} className="w-12 h-12 rounded-full object-cover shrink-0 border-2 border-yellow-400" />
                    ) : (
